...
type BalanceResult = { totalBalance?: string } | null
type OwnedObjectsResult = {
  data?: Array<{
    data: {
      ...
      version?: string
      digest?: string
      display?: { data?: { name?: string; description?: string; image_url?: string } }
    }
  }>
} | null
